...
export default function Footer() {
    return (
        <footer className="absolute bottom-0 w-full max-w-full bg-footer flex flex-col justify-center md:flex-row md:justify-around rounded-t-[3.5rem] md:rounded-t-[7.25rem] pb-5 md:pb-0">
