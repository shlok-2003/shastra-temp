...
export default function Header() {
    ...
    return (
        <header className="fixed z-10 backdrop-filter backdrop-blur-sm top-0 flex flex-row w-full px-1 text-black bg-transparent sm:px-5 pt-3 pb-2 sm:justify-between">
