        ...
        <>
            ...
            <div className="flex flex-col relative">
                ...
                <div className="grid grid-cols-4 gap-1 pl-5 md:pl-10">
                    <div className="col-span-4 sm:col-span-1 my-auto mr-2 flex h-full justify-center sm:justify-normal items-center mb-3 sm:mb-0">
                        <img src={Thumbnail} className="inline-block h-28 sm:h-32 md:h-44 lg:h-60"/>
                    </div>
                    <p className="text-xs relative z-[5] md:text-xl text-justify my-auto md:pr-20 pr-5 col-span-4 sm:col-span-3 mx-5 sm:mx-0">
