...
export default function Home() {
    return (
        <div className="relative -z-10">
            <div className="h-60 sm:h-72 md:h-[17rem] lg:h-80 w-full bg-home rounded-b-[76px] md:rounded-b-[94px] lg:rounded-b-[114px]">
                <div className="relative top-28 flex flex-row justify-around items-center mx-2">

                    <span className="uppercase font-bold text-xl min-[500px]:text-2xl sm:text-3xl md:text-4xl lg:text-5xl">
                        <h1 className="text-[#000778]">Welcome to the</h1>
                        <h1 className="text-[#000778]">Official Page of</h1>
                        <h1 className="text-transparent bg-clip-text bg-gradient-to-r from-[#030B98] from-[16.16%] to-[#FF9201] to-[43.13%] text-2xl min-[500px]:text-4xl sm:text-5xl md:text-6xl lg:text-7xl">Coding Club</h1>
                    </span>
